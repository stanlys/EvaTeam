...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppMOCKIndexTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DEFAULT_ARTICLES", function () {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_notfound_notfound_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_article_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(dialog, dialogService, articleService) {
        var _this = this;
        ...
        dialogService.isShowDialog$.subscribe(function (isShow) {
          if (isShow) _this.openDialog();
        });
      }
      ...
      _createClass(AppComponent, [{
        ...
        value: function openDialog() {
          ...
          var dialogRef = this.dialog.open(_components_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_1__["DialogComponent"], {
            data: {
              title: '',
              body: ''
            }
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            _this2.dialogService.hideOrShow();

            if (!result.article) return;

            _this2.articleService.addArticle({
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_5__["NavbarComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterOutlet"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_article_article_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/article/article.component */
    "./src/app/components/article/article.component.ts");
    /* harmony import */


    var _components_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/dialog/dialog.component */
    "./src/app/components/dialog/dialog.component.ts");
    /* harmony import */
    ...
    var _components_notfound_notfound_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./components/notfound/notfound.component */
    "./src/app/components/notfound/notfound.component.ts");
    /* harmony import */


    var _components_wrapper_wrapper_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./components/wrapper/wrapper.component */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialogModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_10__["AppComponent"], _components_notfound_notfound_component__WEBPACK_IMPORTED_MODULE_14__["NotfoundComponent"], _components_wrapper_wrapper_component__WEBPACK_IMPORTED_MODULE_15__["WrapperComponent"], _components_article_article_component__WEBPACK_IMPORTED_MODULE_11__["ArticleComponent"], _components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_13__["NavbarComponent"], _components_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_12__["DialogComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialogModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppComponentsArticleArticleComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_article_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/services/article.service */
    "./src/app/services/article.service.ts");

    var ArticleComponent = /*#__PURE__*/function () {
      function ArticleComponent(router, articleService) {
        var _this3 = this;
        ...
        this.router = router;
        this.articleService = articleService;
        this.article = ''; //можно реализовать через дополнительный компонент, но в данном случае нет смысла

        this.router.paramMap.subscribe(function (newValue) {
          var id = newValue.get('id');

          if (id === null) {
            _this3.article = 'Ознакомтесь с нашими статьями в боковом меню. Добавить статьи можно с помощью кнопки снизу. ';
            return;
          }

          var article = _this3.articleService.getArticleById(Number(id));

          if (article) _this3.article = article.body;else _this3.article = 'статья не найдена ';
        });
      }
    ...
    ArticleComponent.ɵfac = function ArticleComponent_Factory(t) {
      return new (t || ArticleComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_article_service__WEBPACK_IMPORTED_MODULE_2__["ArticleService"]));
    };
  ...
  function srcAppComponentsDialogDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    DialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 17,
      vars: 5,
      consts: [["mat-dialog-title", ""], [1, "mat-typography"], [1, "example-form", 3, "formGroup"], [1, "example-full-width"], ["matInput", "", "placeholder", "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0441\u0442\u0430\u0442\u044C\u0438", "formControlName", "title", "required", "true", "cdkFocusInitial", ""], ["required", "true", "matInput", "", "placeholder", "\u0422\u0435\u043A\u0441\u0442 \u0441\u0442\u0430\u0442\u044C\u0438", "formControlName", "body"], ["align", "end"], ["mat-button", "", "mat-dialog-close", ""], ["mat-raised-button", "", "color", "primary", 3, "disabled", "mat-dialog-close"]],
  ...
  function srcAppComponentsNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_article_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/services/article.service */
    "./src/app/services/article.service.ts");
    /* harmony import */
    ...
    var NavbarComponent = /*#__PURE__*/function () {
      function NavbarComponent(articleService, dialogService) {
      ...
      _createClass(NavbarComponent, [{
        ...
        key: "onHideShowClick",
        value: function onHideShowClick() {
    ...
    NavbarComponent.ɵfac = function NavbarComponent_Factory(t) {
      return new (t || NavbarComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_article_service__WEBPACK_IMPORTED_MODULE_1__["ArticleService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_2__["DialogService"]));
    };
    ...
    NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 1,
      consts: [[1, "navbar"], ["class", "navItem", 3, "routerLink", 4, "ngFor", "ngForOf"], ["mat-fab", "", "color", "primary", 1, "addBtn", 3, "click"], [1, "navItem", 3, "routerLink"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButton"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIcon"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterLinkWithHref"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NavbarComponent, [{
        ...
        return [{
          type: src_app_services_article_service__WEBPACK_IMPORTED_MODULE_1__["ArticleService"]
        }, {
  ...
  /***/
  function srcAppComponentsWrapperWrapperComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppServicesArticleServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ArticleService = /*#__PURE__*/function () {
      ...
      _createClass(ArticleService, [{
        key: "addArticle",
        value: function addArticle(newArticle) {
          var id = this.articles.length + 1;
          this.articles.push(Object.assign(Object.assign({}, newArticle), {
            id: id
          }));
          return id;
        }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/stan/Documents/Projects/Angular/EvaTeam/app9/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
